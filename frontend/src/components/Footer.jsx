        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Making our planet greener, one tree at a time. Join our mission to create 
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'Events', 'Fundraise', 'Blog', 'About Us', 'Contact Us'].map((item) => (
                <li key={item}>
                  <a
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center">
                ...
                <a href="mailto:solveeaseofficial@gmail.com" className="text-gray-400 hover:text-emerald-500">
                  solveeaseofficial@gmail.com
                </a>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-emerald-500 mr-2" />
                <a href="tel:+1234567890" className="text-gray-400 hover:text-emerald-500">
                  +91 72751 56652
                </a>
              </li>
              <li className="flex items-center">
